...
#else
static inline void aee_record_cpu_dvfs_in(struct mt_cpu_dvfs *p) {}
static inline void aee_record_cpu_dvfs_out(struct mt_cpu_dvfs *p) {}
static inline void aee_record_cpu_dvfs_step(unsigned int step) {}
static inline void aee_record_cci_dvfs_step(unsigned int step) {}
static inline void aee_record_cpu_dvfs_cb(unsigned int step) {}
static inline void aee_record_cpu_volt(struct mt_cpu_dvfs *p, unsigned int volt) {}
static inline void aee_record_freq_idx(struct mt_cpu_dvfs *p, int idx) {}

static inline void _mt_cpufreq_aee_init(void) {}
#endif
